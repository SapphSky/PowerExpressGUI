...
if (Test-Path -Path $FilePath) {
    ...
    Write-Host "Error: $FilePath not found. Aborting.";
}
...
schtasks /create /sc ONLOGON /tn "powerexpressgui\Install Drivers" /tr $FilePath /ru System /mo ONLOGON /z /rl HIGHEST /delay 0000:10;
